...
final class CommonErrorTests: XCTestCase {
    ...
    func testForceError() {
        ...
        XCTAssertEqual(CommonError.responseUnsuccessful(message: "failed", displayMessage: "Error").description, "Response Unsuccessful Error -> failed")
    ...
    func testForceErrorDescriptions() {
        ...
        XCTAssertEqual(CommonError.responseUnsuccessful(message: "failed", displayMessage: "Error").errorDescription, "Response Unsuccessful Error -> failed")
